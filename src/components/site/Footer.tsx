        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-4">
            ...
            <p className="text-[#94A3B8] text-[15px] leading-[1.6] mt-4 mb-6 max-w-sm">
              Accounting compliance specialists.
            </p>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+12898120152" className="inline-flex items-center min-h-[44px] sm:min-h-0 text-[#94A3B8] text-[14px] hover:text-white transition-colors">289-812-0152</a>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={16} className="text-[#E07B39] shrink-0" />
                <a href="mailto:info@theaccounting.site" className="inline-flex items-center min-h-[44px] sm:min-h-0 text-[#94A3B8] text-[14px] hover:text-white transition-colors break-all">info@theaccounting.site</a>
              </li>
            </ul>
      ...
      <div style={{ background: "rgba(0,0,0,0.2)" }}>
        <div className="mx-auto max-w-[1400px] px-5 sm:px-10 lg:px-20 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-[13px]">
            <Link to="/privacy" className="inline-flex items-center min-h-[44px] sm:min-h-0 text-[#64748B] hover:text-[#E07B39] transition-colors">Privacy Policy</Link>
            <span className="text-[#374151]">|</span>
            <Link to="/terms" className="inline-flex items-center min-h-[44px] sm:min-h-0 text-[#64748B] hover:text-[#E07B39] transition-colors">Terms of Service</Link>
            <span className="text-[#374151]">|</span>
            <Link to="/sitemap" className="inline-flex items-center min-h-[44px] sm:min-h-0 text-[#64748B] hover:text-[#E07B39] transition-colors">Sitemap</Link>
          </div>
        </div>
      </div>
    </footer>
...
function FooterLink({ to, children }: { to: string; children: React.ReactNode }) {
  return (
    <li>
      <Link
        to={to}
        className="group flex items-center gap-2 text-[14px] text-[#94A3B8] py-2 min-h-[44px] sm:min-h-[36px] hover:text-[#E07B39] hover:pl-1 transition-all duration-200"
      >
